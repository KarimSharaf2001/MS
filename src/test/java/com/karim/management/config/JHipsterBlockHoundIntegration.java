package com.karim.management.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.karim.management.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.karim.management.security.DomainUserDetailsService", "createSpringSecurityUser");
